'''
Slightly modified version of SharpShooter (https://github.com/mdsecactivebreach/SharpShooter)
...
- sudo python2 SharpShooter.py --payload js --dotnetver 4 --stageless --rawscfile /home/xoperator/shell.txt --output example
'''

#! /usr/bin/env python
# SharpShooter Original Author:
